...
\begin{itemize}
    ...
    \item Extend the use of explainable machine learning to investigate what affect that thrombolysis has on patient outcome, in addition to what affects whether a patient receives thrombolysis or not.
